...
skills: ["Unity", "C#", "Jira", "Documentation"]
...
When The Stack resolves, actions stay in the Stack for the next turn, generating persistence.
...
The results contribute both a historical perspective on the stack and new insights into player experience when foundational mechanics are made explicit.
